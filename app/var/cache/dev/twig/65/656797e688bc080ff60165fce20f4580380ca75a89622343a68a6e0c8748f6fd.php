...
class __TwigTemplate_31dfa77facda466f77330da779f745c3f3667e18bffebbb32de9780ae143f1e3 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 36
        if ((((isset($context["back_to_list_path"]) || array_key_exists("back_to_list_path", $context))) ? (_twig_default_filter((isset($context["back_to_list_path"]) || array_key_exists("back_to_list_path", $context) ? $context["back_to_list_path"] : (function () { throw new RuntimeError('Variable "back_to_list_path" does not exist.', 36, $this->source); })()), false)) : (false))) {
            // line 37
...
{% endblock %}", "default/_form.html.twig", "/Users/ola/PhpstormProjects/blog/app/templates/default/_form.html.twig");
    }
}
