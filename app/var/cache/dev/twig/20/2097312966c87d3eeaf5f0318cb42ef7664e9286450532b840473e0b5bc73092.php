...
/* post/view.html.twig */
class __TwigTemplate_6a453dfd5b63fa092b8f30c55d1a5f2003be8a5101088f562cbaff9b4ed1c4f6 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 15
        if (((isset($context["post"]) || array_key_exists("post", $context)) && twig_length_filter($this->env, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 15, $this->source); })())))) {
            // line 16
...
{% endblock %}", "post/view.html.twig", "/Users/ola/PhpstormProjects/blog/app/templates/post/view.html.twig");
    }
}
