    ...
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
                    ...
                    .')'
                .')'
                .'|/category/([1-9]\\d*)/delete(*:196)'
                .'|/post/(?'
                    .'|([1-9]\\d*)(*:223)'
                    .'|([1-9]\\d*)/edit(*:246)'
                    .'|([1-9]\\d*)/delete(*:271)'
                .')'
                .'|/tag/([1-9]\\d*)/delete(*:302)'
            .')/?$}sD',
    ],
    [ // $dynamicRoutes
        ...
        196 => [[['_route' => 'category_delete', '_controller' => 'App\\Controller\\CategoryController::delete'], ['id'], ['GET' => 0, 'DELETE' => 1], null, false, false, null]],
        223 => [[['_route' => 'post_view', '_controller' => 'App\\Controller\\PostController::view'], ['id'], null, null, false, true, null]],
        246 => [[['_route' => 'post_edit', '_controller' => 'App\\Controller\\PostController::edit'], ['id'], ['GET' => 0, 'PUT' => 1], null, false, false, null]],
        271 => [[['_route' => 'post_delete', '_controller' => 'App\\Controller\\PostController::delete'], ['id'], ['GET' => 0, 'DELETE' => 1], null, false, false, null]],
        302 => [
